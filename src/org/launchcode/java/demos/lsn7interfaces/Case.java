...
public class Case {
    ...
    public Case(){
        ...
        Topping topping2 = new Topping("Cajeta syrup", 0.65, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("pecans", 0.55, new ArrayList<>(Arrays.asList("nuts")));
    }
